...
if __name__=='__main__':
    ...
    parser.add_argument('--meancont-no-errors', type=str, default='delta_attributes_boring.fits.gz')
    parser.add_argument('--meancont-with-errors', type=str, default='delta_attributes_boring_500.fits.gz')
    parser.add_argument('--pixel-dist', type=str, default='delta_attributes_boring.fits.gz')
    parser.add_argument('--qso-catalog', type=str, default='zcat_drq.fits')
    parser.add_argument('--xiqq', type=str, default='xi_qq_model_lyacolore.fits')
